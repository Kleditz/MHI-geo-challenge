...
st.title("`Mangrove Health Index` - `Jawa Tengah`")
...
# Import aoi vector
aoi = (ee.FeatureCollection('projects/ee-kadekpremaswara/assets/jtg_mw'))
...
# Display MHI
geom = ee.Geometry.Point([108.897556,-7.706171])
